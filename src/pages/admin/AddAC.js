...
const AddAC = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    discountPercent: '',
    benefits: '',
    condition: 'Brand New', // 'Brand New' or 'Refurbished'
    dimensions: '',
    features: [],
    status: 'Available',
    images: [],
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.name || !formData.brand || !formData.model || !formData.capacity || !formData.type || !formData.location) {
      setError('Please fill all required fields');
      return;
    }

    // Check if at least one tenure price is filled
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <textarea
                ...
                onChange={handleChange}
                rows="3"
                placeholder="List the benefits of this AC"
                className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-blue"
              />
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  placeholder="e.g., 30x20x15 inches"
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-blue"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="flex gap-2 mb-2">
                <input
                  ...
                  placeholder="Add a feature (e.g., 4-Way Swing)"
