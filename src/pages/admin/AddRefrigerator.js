...
const AddRefrigerator = () => {
    ...
    const [formData, setFormData] = useState({
        name: '',
        capacity: '', // 190 litres, 210 litres, 240 litres
        brand: '',
        description: '',
        location: '',
        price: {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (response.success) {
                showSuccess('Refrigerator added successfully!');
                setTimeout(() => {
                    navigate('/admin/manage-products?type=refrigerator');
                }, 1500);
            } else {
                showError(response.message || 'Failed to add Refrigerator');
            }
        } catch (err) {
    ...
    const capacities = ['190 litres', '210 litres', '240 litres', '260 litres', '300 litres'];
    const brands = ['LG', 'Samsung', 'Whirlpool', 'Godrej', 'Haier', 'Panasonic', 'Hitachi', 'Other'];
    ...
    return (
        <div className="min-h-screen bg-background-light py-8">
            ...
            <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
                <h1 className="text-3xl font-bold text-text-dark mb-2">Add New Refrigerator</h1>
                <p className="text-text-light mb-8">Fill in the details to list your Refrigerator for rental</p>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        <div>
                            ...
                            <input
                                ...
                                required
                                placeholder="e.g., LG 240 Litres Double Door"
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                onChange={handleChange}
                                rows="4"
                                placeholder="Describe the refrigerator features, condition, etc."
                                className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-blue"
                            />
                        </div>
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                onChange={handleChange}
                                rows="3"
                                placeholder="List the benefits of this refrigerator"
                                className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-blue"
                            />
                        </div>
                        ...
                        <div>
                            ...
                            <div className="flex gap-2 mb-2">
                                <input
                                    ...
                                    placeholder="Add a feature (e.g., Smart Inverter)"
                        ...
                        <div className="flex space-x-4">
                            ...
                            >
                                {loading ? 'Adding...' : 'Add Refrigerator'}
                            </button>
                        </div>
                    </form>
                </motion.div>
